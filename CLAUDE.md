...
When adding files DO NOT KEEP ALL CODE FILES UNDER ./lib, instead naturally organize files into ./app, ./engine etc. into directories that make sense with each of them having a respective ./src and ./test directory.
